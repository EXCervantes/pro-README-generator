...
function licenseBadge(data) {
    ...
    if (licenseType === "Apache License 2.0") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](https://opensource.org/licenses/Apache-2.0) page for more info.`
    };
    if (licenseType === "GNU GPLv3") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](https://www.gnu.org/licenses/gpl-3.0) page for more info.`
    };
    if (licenseType === "MIT License") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](https://opensource.org/licenses/MIT) page for more info.`
    };
    if (licenseType === "BSD 2-Clause 'Simplified' License") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](https://opensource.org/licenses/BSD-2-Clause) page for more info.`
    }
    if (licenseType === "BSD 3-Clause 'New' or 'Revised' License") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](https://opensource.org/licenses/BSD-3-Clause) page for more info.`
    }
    if (licenseType === "Boost Software License 1.0") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](https://www.boost.org/LICENSE_1_0.txt) page for more info.`
    }
    if (licenseType === "Creative Commons Zero v1.0 Universal") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](http://creativecommons.org/publicdomain/zero/1.0/) page for more info.`
    }
    if (licenseType === "Eclipse Public License 2.0") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](https://opensource.org/license/EPL-2.0) page for more info.`
    }
    if (licenseType === "GNU AGPLv3") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](https://www.gnu.org/licenses/agpl-3.0) page for more info.`
    }
    if (licenseType === "GNU General Public License 2.0") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html) page for more info.`
    };
    if (licenseType === "GNU LGPLv2.1") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](https://www.gnu.org/licenses/old-licenses/lgpl-2.1) page for more info.`
    }
    if (licenseType === "Mozilla Public License 2.0") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](https://opensource.org/licenses/MPL-2.0) page for more info.`
    }
    if (licenseType === "The Unlicense") {
        ...
        licenseSection = `This project is licensed under the ${data.license}. Please see the [License](http://unlicense.org/) page for more info.`
    }
    return { licenseUrlString, licenseSection };
};
...
${licenseBadge(data).licenseSection}
